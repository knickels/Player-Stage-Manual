...
tutorial-4-src.zip}, then extract using zip\footnote{Yes, there are
GUI-based ways to do this too.  I won't cover them here.}: \\
\\
{\tt > mkdir \$HOME/tutorial-4}\footnote{I'll assume that you put this directory
in your home directory.  If not, just replace the commands given with the
appropriate directory.} \\
{\tt > cd \$HOME/tutorial-4} \\
{\tt > unzip \$HOME/Downloads/tutorial-4-src.zip}\footnote{Again, your specific path may differ.} \\
{\tt > cd code} \\
{\tt > ls} \\
\\
...
correct folder type the following command to run the ``simple world'' that
comes with \plst: \\
{\tt 
> player simple.cfg
}
